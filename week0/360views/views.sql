...
SELECT COUNT("english_title") FROM "views" WHERE "artist" = 'Hokusai' AND "english_title" LIKE '%fuji%';
...
SELECT COUNT("english_title") FROM "views" WHERE "artist" = 'Hiroshige' AND "english_title" LIKE '%Eastern Capital%';
...
SELECT "print_number" AS "Print Number" FROM "views" WHERE "artist" = 'Hiroshige' ORDER BY "entropy";
